...
export class AdminService {
  ...
  addRaffle(raffle: Raffle): Observable<any> {
    return this.http.post(
      this.apiUrl +
        `raffle/add?username=${this.username}&password=${this.hashedPassword}`,
      raffle
    );
  }
  ...
  deleteRaffle(): Observable<any> {
    return this.http.delete(
      this.apiUrl +
        `raffle/delete?username=${this.username}&password=${this.hashedPassword}`
    );
  }
  ...
  getRaffleUsers(): Observable<UsuarioRegister[]> {
    return this.http.get<UsuarioRegister[]>(
      this.apiUrl +
        `user/get?username=${this.username}&password=${this.hashedPassword}`
    );
  }
  ...
  getHistoricalWinners(): Observable<Winner[]> {
    return this.http.get<Winner[]>(
      this.apiUrl +
        `winner/get?username=${this.username}&password=${this.hashedPassword}`
    );
  }
